...
from .serializers import DailyReportSerializer, WeeklyReportSerializer, WeeklyReportGenerateSerializer
from .tasks import generate_weekly_report_task  # 我们将创建这个Celery任务
